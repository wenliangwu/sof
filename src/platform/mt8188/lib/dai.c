...
static int afe_dai_handshake[MT8188_DAI_NUM] = {
	AFE_HANDSHAKE(MT8188_AFE_SOF_DL2, MT8188_IRQ_13, MT8188_MEMIF_DL2),
	AFE_HANDSHAKE(MT8188_AFE_SOF_DL3, MT8188_IRQ_14, MT8188_MEMIF_DL3),
	AFE_HANDSHAKE(MT8188_AFE_SOF_UL4, MT8188_IRQ_21, MT8188_MEMIF_UL4),
	AFE_HANDSHAKE(MT8188_AFE_SOF_UL5, MT8188_IRQ_22, MT8188_MEMIF_UL5),
	AFE_HANDSHAKE(MT8188_AFE_SOF_UL10, MT8188_IRQ_25, MT8188_MEMIF_UL10),
};
